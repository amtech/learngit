	...
	<div data-options="region:'center',title:'设备列表'" scrolling="no" style="overflow:hidden;background-color:#F8F8FF;">
		<div style="background-color:#F8F8FF;align:center;width: 100%;height: 110px;overflow: hidden;">
					...
					<div align="right" style="">
						...
						<a onclick="serachWithCondition();" class="easyui-linkbutton" style="margin-right: 2%;width: 80px;height: 25px;">查询</a>
						<a onclick="checkdetail();" class="easyui-linkbutton" style="margin-right: 2%;width: 80px;height: 25px;">查看详情</a>
						<a onclick="inport();" class="easyui-linkbutton" style="margin-right: 2%;width: 80px;height: 25px;">导入</a>
