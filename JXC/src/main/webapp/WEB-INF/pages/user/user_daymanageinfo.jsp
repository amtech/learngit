...
<body class="easyui-layout">
	<div data-options="region:'center',title:'日经营情况'" scrolling="no" style="overflow:hidden;background-color:#F8F8FF;text-align: center;">
		...
		<div style="text-align: center;">
			...
			<table id="dayinfo" style="text-align: center;border: 1px solid black;border-collapse: inherit;margin-left: 30%;margin-top: 5px;">
