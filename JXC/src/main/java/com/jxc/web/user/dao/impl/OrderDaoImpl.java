...
//	}
	...
	public int queryCountIntimeBc(Map map) {
		return this.getSqlSession().selectOne("queryCountIntimeBc",map);
	}

	@Override
	public int queryDayOrderNums(Map map) {
		return this.getSqlSession().selectOne("changediscountday",map);
	}

	@Override
	public Map queryDayInOut(Map map) {
		return (Map) this.getSqlSession().selectList("queryDayInOut",map);
	}

	@Override
	public void updateSimLastRentDate(Map map) {
		this.getSqlSession().update("updateSimLastRentDate",map);
	}

	@Override
	public Map queryDayInOutByCountry(Map map) {
		return (Map) this.getSqlSession().selectList("queryDayInOutByCountry",map);
	}

	@Override
	public int queryOneDayOrderCount(Map map) {
		return this.getSqlSession().selectOne("queryOneDayOrderCount",map);
	}
