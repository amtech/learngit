...
import com.qqms.util.FileUtil;
import com.qqms.util.PageUtil;
import com.qqms.util.ZipUtils;
...
public class DbBackUpAction extends BaseAction implements ModelDriven<BackupScheduleConfig>
{
	...
	*/
	public String checkBackUp() throws Exception
	{
		...
		if ("".equals(fileName)||null==fileName)
		{
			...
			String zipDir = DBBackUpUtil.getZipMkdirsPath();
			...
			if (file.exists())
			{
				...
				String zipName=DBBackUpUtil.getZipFileName(fileName);
	...
	*/
	public String downBackUpFile() throws Exception
	{
		...
		String sqlName =DBBackUpUtil.getZipMkdirsPath()+ zipName;
