...
margin-left: 88px;
  ...
  <body>
	...
	<span style="position: absolute;left:670px; top: 160px; font: 40px bold;">钱钱金融OA办公系统 -OASYS</span>
	<div id="login">
		...
		<div class="inner">
			...
			<div class="formLogin">
				<form name="formLogin" action="index.do" id="formLogin" method="post">
	...
	<div id="versionBar">
		<div class="copyright">
			<span><strong>Copyright © </strong>&nbsp; 钱钱金融信息服务（北京）有限公司</span>
		</div>
	</div>
</body>
</html>
