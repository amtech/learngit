	...
	$.messager.confirm('提示', '点击按钮之后将进入下一个任务活动环节,此任务将对您不可见!', function(r){
		if (r){
			var data = {
				...
				"appNo":$row.appNo,
				"taskId":$row.taskId,
				"handleResult":result=='zongcaizhulitongguo'?1:0
			}
			$.ajax({
				type:"POST",
...
<div data-options="region:'north',title:'North Title',split:true">
	...
	<div style="margin-left: 25px;margin-bottom: 5px;">
		<a href="javascript:void(0);" class="easyui-linkbutton" onclick="submitTask('zongcaizhulitongguo',this);">总裁助理通过</a>
		<a href="javascript:void(0);" class="easyui-linkbutton" onclick="submitTask('zongcaizhulibohui',this);">总裁助理驳回</a>
	</div>
