				...
				<tr>
				   ...
				   <td colspan="2" align="right">
					...
					<a id="checkAttachment" href="javascript:void(0);" class="easyui-linkbutton">查看附件</a>	
				      <a href="javascript:void(0)" id="save" class="easyui-linkbutton" iconCls="icon-save" onclick="saveTaskFunc('DepartmentHeadsSubmit',1);">审批通过</a>
				      <a href="javascript:void(0)" id="rset" class="easyui-linkbutton" onclick="saveTaskFunc('DepartmentHeadsBack',0);">审批驳回</a>
				   </td>
				</tr>					
			</table>
		</form>
