			...
			<table class="table"  width="95%">
				...
				<tr>
				   ...
				   <td colspan="2" align="right">
				      ...
				      <a href="javascript:void(0)" id="save" class="easyui-linkbutton" iconCls="icon-save" onclick="saveTaskFunc('GeneralManagerSubmit',1);">审批通过</a>
				      <a href="javascript:void(0)" id="rset" class="easyui-linkbutton" onclick="saveTaskFunc('GeneralManagerBack',0);">审批驳回</a>
				   </td>
				</tr>					
			</table>
		</form>
