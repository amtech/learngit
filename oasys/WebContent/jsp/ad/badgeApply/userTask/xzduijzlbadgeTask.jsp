...
<div data-options="region:'north',title:'North Title',split:true">
	<div style="width: 986px;height: 190px;overflow: auto;">
		...
		<div style="width: 980px;height:30px;">
			<a href="javascript:void(0);" class="easyui-linkbutton" onclick="microcreditOpinion('AdminAssistantPass','1');">工牌申请通过</a>
			<a href="javascript:void(0);" class="easyui-linkbutton" onclick="microcreditOpinion('AdminAssistantRegect','0');">工牌申请驳回</a>
		</div>
