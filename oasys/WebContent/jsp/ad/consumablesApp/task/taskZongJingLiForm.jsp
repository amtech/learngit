			...
			<table class="table"  width="95%">
				...
				<tr>
				   <td colspan="4">
				      ...
				      <a href="javascript:void(0)" id="save" class="easyui-linkbutton" iconCls="icon-save" onclick="saveTaskFunc('ZongJingLiTongGuo',1);">审批通过</a>
				      <!-- <a href="javascript:void(0)" id="rset" class="easyui-linkbutton" onclick="saveTaskFunc('ZongJingLiBoHui',0);">审批驳回</a> -->
				   </td>
				</tr>					
			</table>
		</form>
