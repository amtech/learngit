			...
			<table class="table"  width="95%">
				...
				<tr>
				   ...
				   <a id="upploadAttachment" href="javascript:void(0);" class="easyui-linkbutton" >上传附件</a>	
				      ...
				      <a href="javascript:void(0)" id="save" class="easyui-linkbutton" iconCls="icon-save" onclick="saveTaskFunc('XingZhengJingLiTongGuo',1);">审批通过</a>
				      <a href="javascript:void(0)" id="rset" class="easyui-linkbutton" onclick="saveTaskFunc('XingZhengJingLiBoHui',0);">审批驳回</a>
				   </td>
				</tr>					
			</table>
		</form>
