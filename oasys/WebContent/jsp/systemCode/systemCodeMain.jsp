...
<html>
		...
		<script type="text/javascript">
			...
			$(function() {
				 ...
				 $grid=$dg.treegrid({
					...
					treeField: 'dictName',
					 frozenColumns:[[
					                 {title:'字典名称',field:'dictName',align : 'left',width:parseInt($(this).width()*0.2),
  ...
  <body>
  	<div class="well well-small" style="margin-left: 5px;margin-top: 5px">
				...
				<p>
					在此你可以对<span class="label-info"><strong>数据字典</strong></span>进行编辑! 
				</p>
			</div>
    <div id="tb" style="padding:10px;height:auto">
  		...
  		<table id="dg" title="数据字典管理"></table>
  </body>
</html>
