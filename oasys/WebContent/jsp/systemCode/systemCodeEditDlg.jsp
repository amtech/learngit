...
<div class="easyui-layout" data-options="fit:true,border:false">
	...
	<input name="tempId" id="tempId"  type="hidden" value="<%= request.getParameter("tempId")%>"/>
		<form id="form" method="post">
			<fieldset>
				<legend><img src="extend/fromedit.png" style="margin-bottom: -3px;"/> 字典编辑</legend>
				...
				<input name="codePid" id="codePid"  type="hidden"/>
				 <table>
					 <tr>
					    <th>字典名称</th>
						<td><input name=dictName id="dictName" placeholder="请输入字典名称" class="easyui-textbox easyui-validatebox" type="text" /></td>
						<th>父项模块</th>
					 ...
					 <tr>
						...
						<th>字典编码</th>
						<td><input id="dictCode" name="dictCode" type="text" class="easyui-textbox easyui-validatebox"/></td>
					 </tr>
					 <tr>
					 	<th>字典图标</th>
