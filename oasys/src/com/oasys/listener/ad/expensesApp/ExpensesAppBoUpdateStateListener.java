 ...
 */
public class ExpensesAppBoUpdateStateListener implements ExecutionListener{
	...
	public void notify(DelegateExecution execution) throws Exception {
		...
		if(executionEntity.getTransition()!=null){
			...
			expensesAppServiceImpl.updateExpensesAppStatus(Integer.valueOf(paId), Constants.EXPENSESAPP_BO +"_"+ executionEntity.getTransition().getId());
		}
	}
