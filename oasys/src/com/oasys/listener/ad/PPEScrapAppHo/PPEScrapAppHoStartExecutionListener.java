package com.oasys.listener.ad.PPEScrapAppHo;
...
public class PPEScrapAppHoStartExecutionListener implements ExecutionListener {
	...
	public void notify(DelegateExecution execution) throws Exception {
		...
		// 修改订单的状态的信息
		ppeScrapAppService.updPPEScrapProcessStatus(id,"2");
	}
