...
public class PurchaseAppBoProcessStopListener implements ExecutionListener {
	...
	public void notify(DelegateExecution execution) throws Exception {
		...
		PurchaseAppService purchaseAppService = (PurchaseAppService) ctx
				.getBean("purchaseAppService");
