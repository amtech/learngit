 ...
 */
public class PurchaseAppBoUpdateStateListener implements ExecutionListener{
	...
	public void notify(DelegateExecution execution) throws Exception {
		...
		if(executionEntity.getTransition()!=null){
			...
			purchaseAppServiceImpl.updatePurchaseAppStatus(Integer.valueOf(paId),Constants.PURCHASEAPP_BO+"_"+executionEntity.getTransition().getId());
		}
	}
