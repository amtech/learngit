...
public class PublicDaoImpl<T> implements PublicDao<T> {
	...
	public Long findTotalCount(String sql) {
		sql = "select * from (" + sql + ") newTableName";
	 ...
	 * @param pageUtil
	 * @return 
	 * @see com.oasys.dao.PublicDao#findBySql(java.lang.String, com.oasys.util.PageUtil)
	 */
